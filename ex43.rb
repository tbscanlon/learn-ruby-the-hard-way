...
class CentralCorridor < Scene
  ...
  def enter
    ...
    if action == "shoot!"
      puts "Quick on the draw you yank out your blatser and fire it at the Gothon."
      ...
      puts "bang your head on the wall and pass out."
      ...
      puts "Lbhe zbgure vf vb sng, jura fur fvgf nebhaq gur ubhfr, fur fvgf nebhaq gur ubhfr."
...
class TheBridge < Scene
  ...
  def enter
    ...
    if action == "throw the bomb"
      ...
      puts "Now that the bomb is placed you can run to the escape pod to"
...
class EscapePod < Scene
  ...
  def enter
    ...
    if guess != good_pod
      ...
      puts "The pod easily slides out into the void of space, then"
      puts "implodes as the hull ruptures, chrushing your body into"
      puts "jam jelly."
      return 'death'
    else
      puts "you jump into pod #{guess} and hit the eject button."
...
class Map
  @@scenes = {
    ...
    'laser_weapon_armoury' => LaserWeaponArmoury.new,
